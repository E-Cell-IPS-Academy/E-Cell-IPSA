...
const AdminContactManagement: React.FC = () => {
  ...
  const exportToCSV = () => {
    ...
    const rows = submissions.map((s) => [
      ...
      `"${s.message.replace(/"/g, '""')}"`,
      s.createdAt
        ? new Date((s.createdAt as any).seconds * 1000).toLocaleDateString()
        : "",
      s.read ? "Yes" : "No",
    ]);
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        >
          ...
          <p className="text-gray-400">
            Manage contact info and view form submissions
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="flex gap-1 bg-white/5 p-1 rounded-xl w-fit border border-white/10"
        >
          <button
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      rows={2}
                      className="w-full pl-10 pr-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-purple-500 resize-none"
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                ...
                {
                  label: "Read",
                  value: submissions.length - unreadCount,
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <h3
                            className={`font-semibold truncate ${sub.read ? "text-gray-300" : "text-white"}`}
                          >
                            {sub.name}
                          </h3>
                          <span className="text-gray-500 text-xs flex-shrink-0">
                            {sub.createdAt
                              ? new Date(
                                  (sub.createdAt as any).seconds * 1000
                                ).toLocaleDateString()
                              : ""}
                          </span>
                        </div>
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      {viewingSub.createdAt
                        ? new Date(
                            (viewingSub.createdAt as any).seconds * 1000
                          ).toLocaleString()
                        : "Unknown"}
                    </p>
                  </div>
