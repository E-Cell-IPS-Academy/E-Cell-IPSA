...
const AdminSiteSettings: React.FC = () => {
  ...
  const handleImageUpload = async (
    ...
    const setUploading =
      field === "logo" ? setUploadingLogo : setUploadingFavicon;
    try {
      setUploading(true);
      ...
      showNotification(
        "success",
        `${field === "logo" ? "Logo" : "Favicon"} uploaded!`
      );
    } catch {
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        >
          ...
          <p className="text-gray-400">
            Configure global site options and branding
          </p>
        </motion.div>
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-purple-500 max-w-xs"
                  placeholder="2024"
                />
              </div>
            </div>
            ...
            <div className="p-6">
              <div className="flex items-center justify-between py-3 px-4 bg-white/5 border border-white/10 rounded-xl">
                ...
                <button
                  ...
                  className={
                    formData.maintenanceMode ? "text-red-400" : "text-gray-500"
                  }
                >
              ...
              {formData.maintenanceMode && (
                <motion.p
                  ...
                  className="mt-3 text-red-400 text-sm bg-red-500/10 border border-red-500/20 rounded-xl px-4 py-3"
                >
                  Warning: The website is currently in maintenance mode. Only
                ...
                >
                  ...
                  <div className="rounded-xl overflow-hidden">
                    <div
                      ...
                      style={{
                        backgroundColor: formData.announcementBar.bgColor,
                      }}
                    >
                      {formData.announcementBar.text ||
                        "Announcement text here..."}
                      {formData.announcementBar.link && (
                        <span className="ml-2 underline opacity-80">
                          Learn more
                        </span>
                      )}
                    </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleAnnouncementChange("text", e.target.value)
                      }
                      className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-purple-500"
                    ...
                    <div className="flex items-center gap-3 flex-wrap">
                      ...
                      {COLOR_PRESETS.map((color) => (
                        <button
                          ...
                          type="button"
                          onClick={() =>
                            handleAnnouncementChange("bgColor", color)
                          }
                          className={`w-8 h-8 rounded-lg border-2 transition-transform hover:scale-110 ${
                            formData.announcementBar.bgColor === color
