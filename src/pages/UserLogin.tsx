// Create /src/pages/UserLogin.tsx
...
const UserLogin: React.FC = () => {
  ...
  const { login, loginWithGoogle, resetPassword, error, clearError } =
    useAuth();
          ...
          {!showForgotPassword ? (
            <>
              ...
              >
                ...
                <p className="text-gray-400">Sign in to your E-Cell account</p>
              </motion.div>
            ...
            <>
              ...
              <form onSubmit={handlePasswordReset} className="space-y-6">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-gradient-to-r from-purple-500 to-blue-500 text-white font-semibold py-3 px-6 rounded-lg hover:from-purple-600 hover:to-blue-600 focus:outline-none focus:ring-2 focus:ring-purple-500/50 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300"
                >
